...
class ExportController extends Controller
{
    public function index()
    {
        ...
        return view('guru.export.index', compact('pelanggarans', 'kepsek'));
    }
    ...
    public function exportPelanggaran(Request $request)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('guru.export.pelanggaran', compact('pelanggarans', 'kepsek'));
    }
    ...
    public function suratSanksi($pelanggaranId)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('guru.export.surat-sanksi', compact('pelanggaran', 'kepsek'));
    }
