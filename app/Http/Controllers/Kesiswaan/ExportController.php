...
class ExportController extends Controller
{
    public function index()
    {
        ...
        return view('kesiswaan.export.index', compact('pelanggarans', 'prestasis', 'kepsek'));
    }
    ...
    public function exportPelanggaran(Request $request)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('kesiswaan.export.pelanggaran', compact('pelanggarans', 'kepsek'));
    }
    ...
    public function suratSanksi($pelanggaranId)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('kesiswaan.export.surat-sanksi', compact('pelanggaran', 'kepsek'));
    }
    ...
    public function exportPrestasi(Request $request)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('kesiswaan.export.prestasi', compact('prestasis', 'kepsek'));
    }
