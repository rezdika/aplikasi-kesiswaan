...
class ExportController extends Controller
{
    public function index()
    {
        ...
        return view('bk.export.index', compact('pelanggarans', 'prestasis', 'kepsek'));
    }
    ...
    public function exportPelanggaran(Request $request)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('bk.export.pelanggaran', compact('pelanggarans', 'kepsek'));
    }
    ...
    public function exportPrestasi(Request $request)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('bk.export.prestasi', compact('prestasis', 'kepsek'));
    }
    ...
    public function suratSanksi($pelanggaranId)
    {
        ...
        $kepsek = User::where('level', 'kepsek')->with('guru')->first();
        return view('bk.export.surat-sanksi', compact('pelanggaran', 'kepsek'));
    }
