    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('ortu.export.pelanggaran') }}" method="GET" target="_blank">
                        <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('ortu.export.prestasi') }}" method="GET" target="_blank">
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label class="form-label">Tanggal Mulai</label>
                                <input type="date" name="tanggal_mulai" class="form-control">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('ortu.export.surat-sanksi', $p->id) }}" 
