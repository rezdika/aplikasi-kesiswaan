...
<div class="container-fluid px-4">
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <i class="fas fa-exclamation-triangle me-2"></i>
        <strong>Perhatian!</strong> Anak Anda memiliki {{ $sanksiAktif }} sanksi yang sedang berjalan. 
        <a href="/ortu/pelaksanaan-sanksi" class="alert-link">Lihat Detail</a>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card text-white mb-4" style="background: linear-gradient(135deg, #dc3545, #c82333);">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between" style="background: rgba(0,0,0,0.1);">
                    <a class="small text-white stretched-link" href="/ortu/pelaksanaan-sanksi">Lihat Detail</a>
        ...
        <div class="col-xl-5">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Perbandingan Pelanggaran vs Prestasi Anak
                </div>
                        ...
                        <table class="table table-sm table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Str::limit($s->sanksi?->jenisSanksi?->nama_sanksi ?? '-', 20) }}</td>
