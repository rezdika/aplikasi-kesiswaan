...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('walas.dashboard') }}">Dashboard</a></li>
                    ...
                    <div class="alert {{ $notification->is_read ? 'alert-light' : 'alert-info' }} d-flex justify-content-between align-items-start">
                        ...
                        <div>
                            @if(!$notification->is_read)
                                <form action="{{ route('walas.notifications.read', $notification->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
