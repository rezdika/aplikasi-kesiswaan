...
<div class="container-fluid px-4">
    ...
    <a href="{{ route('walas.pelanggaran.create') }}" class="btn btn-primary mb-3">Tambah Pelanggaran</a>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('walas.pelanggaran.edit', $p->id) }}" class="btn btn-sm btn-warning">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
