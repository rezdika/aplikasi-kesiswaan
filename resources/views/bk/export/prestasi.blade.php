...
<body>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    @else
                        <span class="badge-warning">Belum Verifikasi</span>
                    @endif
                </td>
            </tr>
            @empty
    ...
    <div style="margin-top: 40px;">
        ...
        <p><strong>Terverifikasi:</strong> {{ $prestasis->where('terverifikasi', true)->count() }} prestasi</p>
    </div>
    ...
    <div style="margin-top: 50px; float: right;">
        ...
        <p>{{ $kepsek->guru->nama_guru ?? 'Kepala Sekolah' }}</p>
        @if($kepsek && $kepsek->guru && $kepsek->guru->nip)
        <p>NIP. {{ $kepsek->guru->nip }}</p>
        @endif
    </div>
</body>
</html>